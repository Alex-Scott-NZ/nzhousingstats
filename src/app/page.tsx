...
export const metadata: Metadata = {
  ...
  description: 'Track New Zealand property market trends with real-time house listing data across all regions, districts, and suburbs. Updated daily with comprehensive market insights.',
  alternates: {
    canonical: 'https://nzhousingstats.madebyalex.dev/',
  },
  openGraph: {
    title: 'NZ Housing Stats - Property Market Data',
    description: 'Real-time New Zealand property market data and trends across all regions.',
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        <HomepageStructuredData 
          ...
          lastUpdated={allData.HOUSES_TO_BUY.totals?.lastUpdated || new Date().toISOString()}
        />
